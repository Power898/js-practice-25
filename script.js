...
async function getData() {try{const fakeData = await fetchFakeData();
  console.log("Завдання: 1 =========================");
  console.log(fakeData);} catch (error){console.log(error);}}  
...
async function logRandomNumberAfterSeconds(seconds){
  try {const randomNumber = await getRandomNumberAfterSeconds(seconds);
    console.log("Завдання: 2 =========================");
  console.log(randomNumber);} catch (error) {console.log(error);}
}
// Використовуємо try для обробки помилок
